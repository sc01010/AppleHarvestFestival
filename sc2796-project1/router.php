...
if (preg_match('/^\/public\//', $request_uri)) {
  ...
  return False;
} else if (match_routes($request_uri, ['/', '/index'])) {
  require 'pages/index.php';
} else if (match_routes($request_uri, '/description')) {
  require 'pages/description.php';
...
} else if (match_routes($request_uri, ['/product'])) {
